...
<head>
    <meta charset="utf-8">
    <title>GracePath - Education</title>
...
<body>
    ...
    <a
      href="https://wa.me/918086859526?text=Hi%20There!" target="_blank"
      class="floatWatsapp">
        ...
        <div class="row gx-0">
            <div class="col-lg-8 text-center text-lg-start mb-2 mb-lg-0">
                <div class="d-inline-flex align-items-center" style="height: 45px;">
                    <small class="me-3 text-light"><i class="fa fa-map-marker-alt me-2"></i>Ponkunnam, Kottayam, Kerala</small>
                    <small class="me-3 text-light"><i class="fa fa-phone-alt me-2"></i>+91 8086859526</small>
                    <small class="text-light"><i class="fa fa-envelope-open me-2"></i>info@gracepath.in</small>
                </div>
            </div>
            <div class="col-lg-4 text-center text-lg-end">
                <div class="d-inline-flex align-items-center" style="height: 45px;">
                    ...
                    <a class="btn btn-sm btn-outline-light btn-sm-square rounded-circle me-2" href="https://www.instagram.com/gracepathedu?igsh=MXZubXU0MG5vdGQ4cw==" target="_blank"><i class="fab fa-instagram fw-normal"></i></a>
