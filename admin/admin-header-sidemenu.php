            <div class="sb2-1" style="background: none !important;">  
                <!--== USER INFO ==-->
                <div class="sb2-12">
                    <ul>
                        <li><img src="images/admin2.png" alt="">
                        </li>
                        <li>
                            <h5><?php echo $user_name; ?> <span> GracePath</span></h5>
                        </li>
                        <li></li>
                    </ul>
                </div>
                ...
                <div class="sb2-13">
                    <ul class="collapsible" data-collapsible="accordion">
                        <li>
                            <a href="admin-application-list.php" class="menu-active"><i class="fa fa-bar-chart" aria-hidden="true"></i> Applications </a>
                        </li>
                        
						<li>
                            <a href="admin-logout.php"><i class="fa fa-sign-in" aria-hidden="true"></i> Logout</a>
                        </li>
