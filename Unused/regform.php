					...
					<ul class="field-list">
						...
						<li>
							...
							<div class="form-input">
								<select class="form-dropdown" name="gender" required>
									...
									<option value="Female"> BHMS </option>
									<option value="Female"> BSM </option>
									<option value="Female"> BPT </option>
									<option value="Female"> B.PHARM </option>
									<option value="Female"> PHARM.D </option>
									<option value="Female"> M.PHARM </option>
									<option value="Female"> GNM </option>
									<option value="Female"> BSc NURSING </option>
						...
						<li>
							...
							<div class="form-input">
								<select class="form-dropdown" name="gender" required>
									<option value="">&nbsp;</option>
									<option value="Male"> B.Sc. - Accident & Emergency Care Technology </option>
									<option value="Female"> B.Sc. - Audiology & speech Language Pathology </option>
									<option value="Female"> B.Sc. - Cardiac Technology </option>
									<option value="Female"> B.Sc. - Cardio Pulmonary Perfusion Care Technology </option>
									<option value="Female"> B.Sc. - Critical Care Technology </option>
									<option value="Female"> B.Sc. - Dialysis Technology </option>
									<option value="Female"> B.Sc. - Neuro Electrophysiology </option>
									<option value="Female"> B.Sc. - M.L.T. </option>
									<option value="Female"> B.Sc. - Medical Sociology </option>
									<option value="Female"> B.Sc. - Nuclear Medicine Technology </option>
									<option value="Female"> B.Sc. - Operation Theatre & Anaesthesia Technology </option>
									<option value="Female"> B.Sc. - Physician Assistant </option>
									<option value="Female"> B.Sc. - Radiology Imaging Technology </option>
									<option value="Female"> B.Sc. - Radiotherapy Technology </option>
									<option value="Female"> B.Sc. - Medical Record Science </option>
									<option value="Female"> B.Sc. - Respiratory Therapy </option>
									<option value="Female"> Bachelor of Science in Optometry </option>
									<option value="Female"> Bachelor of Science in Prosthetics & Orthotics </option>
